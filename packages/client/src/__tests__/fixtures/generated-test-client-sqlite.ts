 ...
 *
 * Generated at: 2026-09-01T18:03:31.555Z
 */
...
class UserOperations {
  ...
  private prepareCreateData(data: UserCreateInput): Record<string, unknown> {
    for (const relName of ['posts', 'profile']) {
                if ((data as Record<string, unknown>)[relName] !== undefined) {
                  throw new OrkNotImplementedError(
                    `Nested write on relation "${relName}" in User.create`,
  ...
  private prepareUpdateData(data: UserUpdateInput): Record<string, unknown> {
    for (const relName of ['posts', 'profile']) {
                if ((data as Record<string, unknown>)[relName] !== undefined) {
                  throw new OrkNotImplementedError(
                    `Nested write on relation "${relName}" in User.update`,
...
class ProfileOperations {
  ...
  private prepareCreateData(data: ProfileCreateInput): Record<string, unknown> {
    for (const relName of ['user']) {
                if ((data as Record<string, unknown>)[relName] !== undefined) {
                  throw new OrkNotImplementedError(
                    `Nested write on relation "${relName}" in Profile.create`,
                    'Nested writes (create/connect/disconnect) are not yet supported. Create related records independently.'
                  )
                }
              }
  ...
  private prepareUpdateData(data: ProfileUpdateInput): Record<string, unknown> {
    for (const relName of ['user']) {
                if ((data as Record<string, unknown>)[relName] !== undefined) {
                  throw new OrkNotImplementedError(
                    `Nested write on relation "${relName}" in Profile.update`,
                    'Nested writes (create/connect/disconnect) are not yet supported. Update related records independently.'
                  )
                }
              }
...
class PostOperations {
  ...
  private prepareCreateData(data: PostCreateInput): Record<string, unknown> {
    for (const relName of ['author']) {
                if ((data as Record<string, unknown>)[relName] !== undefined) {
                  throw new OrkNotImplementedError(
                    `Nested write on relation "${relName}" in Post.create`,
                    'Nested writes (create/connect/disconnect) are not yet supported. Create related records independently.'
                  )
                }
              }
  ...
  private prepareUpdateData(data: PostUpdateInput): Record<string, unknown> {
    for (const relName of ['author']) {
                if ((data as Record<string, unknown>)[relName] !== undefined) {
                  throw new OrkNotImplementedError(
                    `Nested write on relation "${relName}" in Post.update`,
                    'Nested writes (create/connect/disconnect) are not yet supported. Update related records independently.'
                  )
                }
              }
